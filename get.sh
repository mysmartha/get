...
Check_Arch() {
    ...
    *)
    ...
    CASA_PACKAGES=(
        ...
        "https://ghproxy.com/https://github.com/IceWhaleTech/CasaOS-LocalStorage/releases/download/v0.3.7-1/linux-${TARGET_ARCH}-casaos-local-storage-v0.3.7-1.tar.gz"
        "https://ghproxy.com/https://github.com/IceWhaleTech/CasaOS/releases/download/v0.3.7/linux-${TARGET_ARCH}-casaos-v0.3.7.tar.gz"
